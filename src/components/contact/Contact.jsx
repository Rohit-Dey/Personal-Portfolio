...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_5hc8xmh', 'template_27nzvjn', formRef.current, 'v86LABvz8h5Xc3J6O')
            .then((result) => {
                setSuccess(true )
            }, (error) => {
                setError(true)
    ...
    return (
        <motion.div ref={ref} className="contact" initial='initial' variants={variants} whileInView='animate'>
